...
$sql = "SELECT a.*, CONCAT(u.first_name, ' ', u.last_name) AS username FROM appointments a
...
<div class="page-wrapper">
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="page-title mb-0">Approved Appointments</h3>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-danger deleteBtn" data-appointment-id="<?php echo $row['id']; ?>">Delete</button>
...
$(document).ready(function () {
    ...
    $('.deleteBtn').click(function () {
        // Get the appointment ID from the data-appointment-id attribute
        ...
        if (confirm("Are you sure you want to delete this appointment?")) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: { appointment_id: appointmentId }, // Send the appointment ID to the server
                success: function (response) {
                    ...
                    if (response === 'success') {
                        ...
                        console.error('Error: Unable to delete appointment with ID ' + appointmentId);
                    }
                },

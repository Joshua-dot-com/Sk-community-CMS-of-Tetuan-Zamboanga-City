...
if (isset($_POST['approve'])) {
    ...
    $approve_sql = "UPDATE appointments SET status = 'approved' WHERE id = $appointment_id";
    if (mysqli_query($conn, $approve_sql)) {
        // Redirect to the same page to refresh the pending appointments list
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="page-title mb-0">Pending Appointments</h3>
                    </div>
                </div>
            </div>

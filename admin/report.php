  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="page-title mb-0">User Reports</h3>
                </div>
            </div>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <!-- PHP code to fetch and display reports from the database -->
                    <?php
                        // Include the database connection file
                        include('../db_conn.php');

                        // Fetch all reports sent by users
                        $sql = "SELECT CONCAT(u.first_name, ' ', u.last_name) AS username, r.problem_description, r.problem_image, r.created_at 
                        FROM reports r 
                        ...
                        // Display each report in a table row
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>";
                            echo "<td>" . $row['username'] . "</td>";
                            echo "<td>" . $row['problem_description'] . "</td>";
                            echo "<td>";
                            if (!empty($row['problem_image'])) {
                                echo "<img src='../user/reportpicture/" . $row['problem_image'] . "' alt='Problem Image' style='max-width: 100px; max-height: 100px;'>";
                            } else {
                                echo "No Photo";
                            }
                            echo "</td>";

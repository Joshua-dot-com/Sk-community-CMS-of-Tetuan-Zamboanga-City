...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">make an announcement</h3>
</div>
...
<div class="container mt-5">
    ...
    <form id="addForm" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="file" class="form-control" id="image_path" name="image"  placeholder="Insert Image" accept="image/*" required>
      </div>
...
<script>
    $(document).ready(function() {
      $('#addForm').submit(function(event) {
        ...
        $.ajax({
          url: 'functionadd.php', // URL to handle form submission
          type: 'POST',
          data: formData,
          processData: false,
          contentType: false,
          success: function(response) {
            $('#alertMessage').html('<div class="alert alert-success" role="alert">Announcement added successfully</div>');
            $('#addForm').trigger('reset'); // Reset form fields after successful submission
          },
          error: function(xhr, status, error) {
            $('#alertMessage').html('<div class="alert alert-danger" role="alert">Error adding announcement: ' + error + '</div>');
          }
        });
      });
    });

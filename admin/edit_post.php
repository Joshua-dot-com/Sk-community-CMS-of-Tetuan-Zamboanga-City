...
<div class="row">
<div class="col-md-6">
<h3 class="page-title mb-0">Edit announcement</h3>
</div>
...
<div class="container mt-5">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
        ...
        $query = "SELECT * FROM announcement WHERE id = $post_id";
    ...
    ?>
            <form id="editPostForm" method="POST" action="update_post.php?id=<?php echo $post_id; ?>" enctype="multipart/form-data">

                <div class="form-group">
                    <label for="postTitle">Title</label>
                    <input type="text" class="form-control" id="postTitle" name="post_title" value="<?php echo $post_title; ?>" required>
                </div>
                <div class="form-group">
                    <label for="postDescription">Description</label>
                    <textarea class="form-control" id="postDescription" name="post_description" rows="4" required><?php echo $post_description; ?></textarea>
                </div>
                <div class="form-group">
                    <label for="postImage">Image</label>
                    <input type="file" class="form-control-file" id="postImage" name="post_image" accept="image/*">
                    <img src="<?php echo $image_path; ?>" width="1000" alt="Current Image">
                </div>
        ...
        if (confirm("Are you sure you want to update this post?")) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    window.location.href = 'crudann.php';
                },
